...
class Program
{
    ...
    //                           join department in departmentWorksheet.Cells["H7:I14"]
    ...
    // {
    //     var employees = employeeWorksheet.Cells["B7:F24"].Select(cell => cell.Value).ToArray();
    ...
    // {
    //     var staffDepartments = departmentWorksheet.Cells["H72:I14"].Select(cell => cell.Value?.ToString())
    //         .Where(department => employeeWorksheet.Cells["B7:F24"].Any(cell => cell.Text == "Staff"))
    //         .Distinct();
    ...
    //     {
    //         var staffCount = employeeWorksheet.Cells["B7:F24"].Count(cell => cell.Value?.ToString() == department && employeeWorksheet.Cells["E2:E100"].Any(cell => cell.Text == "Staff"));
    //         if (staffCount >= 2)
    //         {
    //             var employeesInDepartment = from employee in employeeWorksheet.Cells["B7:F24"]
    //                                         join dept in departmentWorksheet.Cells["H7:I14"]
    ...
    // {
    //     var positions = employeeWorksheet.Cells["B7:F24"].Select(cell => cell.Value?.ToString()).Distinct();
    ...
    //         var employeeCount = employeeWorksheet.Cells["B7:F24"].Count(cell => cell.Text == position);
